      ...
      <div className="container-sm">
        <div className={innerClasses}>
          <div className="hero-content">
            <h1 className="text-color-primary mt-0 mb-16 reveal-from-bottom" >
             {teamName}  <br/>
...
HeroSubteam.propTypes = propTypes;
HeroSubteam.defaultProps = defaultProps;

export default HeroSubteam;